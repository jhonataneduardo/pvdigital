    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('im', models.CharField(max_length=11, unique=True, verbose_name='Inscrição Municipal')),
                ('photo', models.ImageField(blank=True, upload_to='companies/%Y/%m/%d/')),
                ('parent_company', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='company.company')),
            ],
        ),
    ]
