...
from school.views import group, teacher, course, student
...
urlpatterns = [
    ...
    path('v1/students/', student.StudentListCreateAPIView.as_view(), name='list_create_student'),
    path('v1/students/<int:pk>/', student.StudentRetrieveUpdateDestroyAPIView.as_view(), name='get_update_delete_student'),
]